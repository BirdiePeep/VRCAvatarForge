            ...
            EditorGUILayout.BeginHorizontal(GUI.skin.box);
            {
                ...
                switch(typeValue)
                {
                    case Globals.ParameterEnum.Custom:
                        logic.enumValueIndex = System.Convert.ToInt32(EditorGUILayout.EnumPopup((ActionItem.Condition.Logic)logic.intValue));
                        break;
                    ...
                    case Globals.ParameterEnum.GestureLeftWeight:
                        logic.enumValueIndex = System.Convert.ToInt32(EditorGUILayout.EnumPopup((ActionItem.Condition.LogicCompare)logic.intValue));
                        break;
                    default:
                        logic.enumValueIndex = System.Convert.ToInt32(EditorGUILayout.EnumPopup((ActionItem.Condition.LogicEquals)logic.intValue));
                        break;
                }
